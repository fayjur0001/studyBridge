...
<input
  ...
  className="flex-1 min-w-[220px] bg-surface-container-low border-none rounded-xl py-2 px-4 font-body-md text-body-md focus:ring-2 focus:ring-primary/20"
/>
<button type="submit" disabled={linking} className="bg-primary text-white px-6 py-2 rounded-xl font-label-md text-label-md hover:opacity-90 disabled:opacity-50">
