          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-outline-variant/20">
                ...
                {applications.filter((a) => `${a.studentName} ${a.studentEmail} ${a.programName} ${a.universityName}`.toLowerCase().includes(searchQuery.toLowerCase())).map((a) => (
                  <tr key={a.id}>
                    <td className="py-5">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">
                ...
                {!loading && applications.length > 0 && applications.every((a) => !`${a.studentName} ${a.studentEmail} ${a.programName} ${a.universityName}`.toLowerCase().includes(searchQuery.toLowerCase())) && <tr><td colSpan={4} className="py-12 text-center text-on-surface-variant font-body-md">No applications match your search.</td></tr>}
              </tbody>
            </table>
          </div>
        </div>
